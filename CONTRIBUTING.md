# Contributing to React TopLoader 🏋🏼‍♂️

We’re excited that you’re interested in contributing to React TopLoader! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/react-top-loader/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/react-top-loader).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/react-top-loader.git
```
...
Thank you for helping improve React TopLoader! 🎉
